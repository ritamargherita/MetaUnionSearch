...
if __name__ == "__main__":
    ...
    """
    ### COMPUTE SIMILARITY (dbpedia) - EVALUATION SET TOPIC AGNOSTIC
    ...
    output_file_path = "../../results/eval/topic-agnostic/dbpedia/cosine_similarities.csv"
    #"""

    """
    ### COMPUTE SIMILARITY (dbpedia) - TEST SET TOPIC AGNOSTIC
    ...
    output_file_path = "../../results/test/topic-agnostic/dbpedia/cosine_similarities.csv"
    #"""

    """
    ### COMPUTE SIMILARITY (dbpedia) - EVALUATION SET TOPIC GUIDED
    query_file_path = "../../results/eval/topic-guided/dbpedia/embeddings/query.csv"     
    candidate_file_path = "../../results/eval/topic-guided/dbpedia/embeddings/candidate.csv"
    output_file_path = "../../results/eval/topic-guided/dbpedia/cosine_similarities.csv"
    #"""

    #"""
    ### COMPUTE SIMILARITY (dbpedia) - TEST SET TOPIC GUIDED
    query_file_path = "../../results/test/topic-guided/dbpedia/embeddings/query.csv"
    candidate_file_path = "../../results/test/topic-guided/dbpedia/embeddings/candidate.csv"
    output_file_path = "../../results/test/topic-guided/dbpedia/cosine_similarities.csv"
    #"""
