...
def process_candidate_file(candidate_filepath, query_files, model, output_filepath):
    """
    """
    ...
    if column_labels:
        ...
        query_embeddings = []
        query_names = []
        for query_filepath in query_files:
...
def main(topics_file, candidate_folder, query_folder, model, output_filepath):
    ...
    for topic in topics:
        ...
        for candidate_file in topic_candidates:
            ...
            process_candidate_file(candidate_filepath, topic_queries, model, output_filepath)
