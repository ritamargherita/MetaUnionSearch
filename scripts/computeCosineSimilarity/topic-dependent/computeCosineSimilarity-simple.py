...
if __name__ == "__main__":
    ...
    """
    ### COMPUTE SIMILARITY (simple) - EVALUATION SET TOPIC DEPENDENT
    ...
    output_file_path = "../../../results/eval/topic-dependent/simple/cosine_similarities.csv"
    #"""

    #"""
    ### COMPUTE SIMILARITY (simple) - TEST SET TOPIC DEPENDENT
    ...
    output_file_path = "../../../results/test/topic-dependent/simple/cosine_similarities.csv"
    #"""
