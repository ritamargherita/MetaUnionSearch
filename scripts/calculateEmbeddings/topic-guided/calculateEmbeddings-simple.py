...
if __name__ == "__main__":
    ...
    """
    ### CALCULATE EMBEDDINGS (simple) - EVALUATION SET CANDIDATE
    folder_path = "../../../data/eval/simple/meta_datalake"
    output_file = "../../../results/eval/topic-guided/simple/embeddings/candidate.csv"
    #"""

    """
    ### CALCULATE EMBEDDINGS (simple) - EVALUATION SET QUERY
    folder_path = "../../../data/eval/simple/meta_query"
    output_file = "../../../results/eval/topic-guided/simple/embeddings/query.csv"
    #"""

    """
    ### CALCULATE EMBEDDINGS (simple) - TEST SET CANDIDATE
    folder_path = "../../../data/test/simple/meta_datalake"
    output_file = "../../../results/test/topic-guided/simple/embeddings/candidate.csv"
    #"""

    #"""
    ### CALCULATE EMBEDDINGS (simple) - TEST SET QUERY
    folder_path = "../../../data/test/simple/meta_query"
    output_file = "../../../results/test/topic-guided/simple/embeddings/query.csv"
    #"""
