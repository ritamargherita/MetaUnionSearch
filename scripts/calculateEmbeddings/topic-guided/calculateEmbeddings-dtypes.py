...
if __name__ == "__main__":
    ...
    output_file = "../../../results/eval/topic-guided/dtypes/embeddings/candidate.csv"
    #"""

    """
    ### CALCULATE EMBEDDINGS (dtypes) - EVALUATION SET QUERY
    folder_path = "../../../data/eval/dtypes/meta_query"
    output_file = "../../../results/eval/topic-guided/dtypes/embeddings/query.csv"
    #"""

    """
    ### CALCULATE EMBEDDINGS (dtypes) - TEST SET CANDIDATE
    folder_path = "../../../data/test/dtypes/meta_datalake"
    output_file = "../../../results/test/topic-guided/dtypes/embeddings/candidate.csv"
    #"""

    #"""
    ### CALCULATE EMBEDDINGS (dtypes) - TEST SET QUERY
    folder_path = "../../../data/test/dtypes/meta_query"
    output_file = "../../../results/test/topic-guided/dtypes/embeddings/query.csv"
    #"""
