...
if __name__ == "__main__":
    ...
    """
    ### CALCULATE EMBEDDINGS (dbpedia) - EVALUATION SET CANDIDATE TOPIC FILTERING
    folder_path = "../../../data/eval/dbpedia/meta_datalake"
    output_file = "../../../results/eval/topic-filtering/dbpedia/embeddings/candidate.csv"
    #"""

    """
    ### CALCULATE EMBEDDINGS (dbpedia) - EVALUATION SET QUERY TOPIC FILTERING
    folder_path = "../../../data/eval/dbpedia/meta_query"
    output_file = "../../../results/eval/topic-filtering/dbpedia/embeddings/query.csv"
    #"""

    """
    ### CALCULATE EMBEDDINGS (dbpedia) - TEST SET CANDIDATE TOPIC FILTERING
    folder_path = "../../../data/test/dbpedia/meta_datalake"
    output_file = "../../../results/test/topic-filtering/dbpedia/embeddings/candidate.csv"
    #"""

    #"""
    ### CALCULATE EMBEDDINGS (dbpedia) - TEST SET QUERY TOPIC FILTERING
    folder_path = "../../../data/test/dbpedia/meta_query"
    output_file = "../../../results/test/topic-filtering/dbpedia/embeddings/query.csv"
    #"""
