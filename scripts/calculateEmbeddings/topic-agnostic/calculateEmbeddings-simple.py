...
if __name__ == "__main__":
    ...
    #"""
    ### CALCULATE EMBEDDINGS (simple data) - EVALUATION SET CANDIDATE
    folder_path = "../../../data/eval/simple/meta_datalake"
    output_file = "../../../results/eval/topic-agnostic/simple/embeddings/candidate.csv"
    #"""

    """
    ### CALCULATE EMBEDDINGS (simple data) - EVALUATION SET QUERY
    folder_path = "../../../data/eval/simple/meta_query"
    output_file = "../../../results/eval/topic-agnostic/simple/embeddings/query.csv"
    #"""

    """
    ### CALCULATE EMBEDDINGS (simple data) - TEST SET CANDIDATE
    folder_path = "../../../data/test/simple/meta_datalake"
    output_file = "../../../results/test/topic-agnostic/simple/embeddings/candidate.csv"
    #"""

    """
    ### CALCULATE EMBEDDINGS (simple data) - TEST SET QUERY
    folder_path = "../../../data/test/simple/meta_query"
    output_file = "../../../results/test/topic-agnostic/simple/embeddings/query.csv"
    #"""
