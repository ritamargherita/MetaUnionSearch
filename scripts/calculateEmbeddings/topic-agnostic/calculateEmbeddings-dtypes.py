...
if __name__ == "__main__":
    ...
    """
    ### CALCULATE EMBEDDINGS (dtypes) - EVALUATION SET CANDIDATE
    folder_path = "../../../data/eval/dtypes/meta_datalake"
    output_file = "../../../results/eval/topic-agnostic/dtypes/embeddings/candidate.csv"
    #"""

    """
    ### CALCULATE EMBEDDINGS (dtypes) - EVALUATION SET QUERY
    folder_path = "../../../data/eval/dtypes/meta_query"
    output_file = "../../../results/eval/topic-agnostic/dtypes/embeddings/query.csv"
    #"""

    """
    ### CALCULATE EMBEDDINGS (dtypes) - TEST SET CANDIDATE
    folder_path = "../../../data/test/dtypes/meta_datalake"
    output_file = "../../../results/test/topic-agnostic/dtypes/embeddings/candidate.csv"
    #"""

    #"""
    ### CALCULATE EMBEDDINGS (dtypes) - TEST SET QUERY
    folder_path = "../../../data/test/dtypes/meta_query"
    output_file = "../../../results/test/topic-agnostic/dtypes/embeddings/query.csv"
    #"""
